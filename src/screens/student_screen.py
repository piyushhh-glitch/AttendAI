...
def student_dashboard():
    ...
    for i,sub_node in enumerate(subjects):
        ...
        def unenroll_button():
            if st.button("Unenroll from this button",type='tertiary',width='stretch',icon=':material/delete_forever:'):
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name=st.text_input("Enter Your Name",placeholder="E.g Piyush Thakur")

            st.subheader("Optional:Voice Only Enrollment")
            st.info("Enter your voice for voice only enrollment")

            audio_data=None

            try:
                audio_data=st.audio_input("Record a short phrase, for e.g I am present , My name is Piyush Thakur")
